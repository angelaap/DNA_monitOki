...
```{r}
#D1 taxonomic level
glomD1<- tax_glom(psNHighPrev, "D1")
...
colours= c( "#332288", "#44AA99", "#88CCEE", "#FFCC00", "#CC3311", "#CC6677", "#999933", "#DDCC77", "#EE3377", "#882255", "#AA4499", "#BBCCEE", "#222255", "#CCEEFF", "#DDAA33","#570D32", "#E5C616", "#D33B44", "#1d3554", "#FFCCCC","#DFE07C","#7F8E39")
...
generalbarplotD1<-plot_bar(psDNA_RS, x= "SS", fill = "D1") +  
...
generalbarplotD1+ theme(legend.position="none")
```
