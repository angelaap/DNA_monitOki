...
for (f in rinko_csv_files) {
  ...
  #folder <- "~/Documents/GitHub/DNA_monitOki/Environmental parameters/Rinko data clean/"
  #new_name <- paste(folder, f, sep = "")
  #print(new_name)
  ...
  path_out <- "~/Documents/GitHub/DNA_monitOki/Environmental parameters/Rinko data clean/"
  fileName <- paste(path_out, gsub('.csv', '_processed.csv', f))
  write.csv(out_removed_id,file.path(path, "my_file.csv"))
